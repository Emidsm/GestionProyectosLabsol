...
function AdminProyectosPage() {
    ...
    const visibleProjects = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockProjects"].filter((p)=>p.status !== 'Borrador' && p.status !== 'En revisión' && p.status !== 'Rechazado con retroalimentación');
    // 2. FILTRO DE BÚSQUEDA Y ESTADO (UI)
    const filteredProjects = visibleProjects.filter((project)=>{
        const matchesSearch = project.title.toLowerCase().includes(searchTerm.toLowerCase()) || project.solicitante.name.toLowerCase().includes(searchTerm.toLowerCase());
...
_s(AdminProyectosPage, "KoKgEdtUEy76A/QWUsoLM22MzQ8=");
...
//# sourceMappingURL=src_d678b4d7._.js.map